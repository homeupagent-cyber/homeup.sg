    ...
    "@graph": [
      {
        ...
        description:
          "What changes when you list with HomeUP instead of a traditional agent: a 24/7 live seller portal, 8-platform video-first exposure, data-backed pricing, under-5-minute enquiry response and a fixed fee from ,999.",
        isPartOf: { "@id": `${SITE_URL}/#website` },
        about: { "@id": ORG_ID },
